...
(function (PCGGame) {
    var ExperientialGameManager = (function () {
        function ExperientialGameManager(game, player) {
            ...
            this._currentPreferenceConditionInPlay = null;
            this._game = null;
            ...
            this.addAdaptationToQueue(5000, function () {
                ...
                _this._updateMobDistribution([35, 25, 20, 20, 0]);
            });
            this.addAdaptationToQueue(5000, function () {
                _this._maxMobAllowed++;
                _this._updateMobDistribution([35, 25, 10, 10, 20]);
            });
        }
        ...
        ExperientialGameManager.prototype.calcType = function (minType, maxType, typeProbabilitiesUpperBoundary) {
            var p = this._randomGenerator.integerInRange(1, 100);
            var type = minType;
        ...
        ExperientialGameManager.prototype.evaluateLootAndInterveneIfDanger = function (loot) {
            ...
            loot.type = 3;
            loot.subType = this._randomGenerator.integerInRange(1, 10) >= 6 ? 4 : 2;
            return loot.type;
        };
        ...
        ExperientialGameManager.prototype._shouldIncreaseDifficulty = function () {
            var previousGameMetricSnapshot = ExperientialGameManager.gameMetricSnapShots.previous;
            var shouldIncreaseDifficulty = false;
            if (!previousGameMetricSnapshot) {
                return shouldIncreaseDifficulty;
            }
            var currentGameMetricSnapshot = this._currentSnapShot;
            var overallGameMetricSnapshot = this._overallSnapShot;
        ...
        ExperientialGameManager.prototype._getMobNullIndexForType = function (type) {
            var index = -1;
            switch (type) {
                case 'MOB':
                    index = 0;
        ...
        ExperientialGameManager.prototype._increasePlatformConcentrationAmountFromNullSpaceStrategy = function () {
            var _this = this;
            var type = 'PLATFORM';
            ...
            var maxPercent = Math.min(nullSpacePercentage, ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT);
        ...
        ExperientialGameManager.prototype._decreasePlatformConcentrationAmountToNullSpaceStrategy = function () {
            var _this = this;
            var type = 'PLATFORM';
            var halfDec = Math.round(ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT / 2);
            var strategy = { isViable: true, strategyFunction: function () { } };
        ...
        ExperientialGameManager.prototype._increaseMobEnemyConcentrationFromNullSpaceStrategy = function () {
            var _this = this;
            var type = 'MOB';
            var nullSpacePercentage = this._probabilityDistributions[type][this._getMobNullIndexForType(type)];
            var strategy = { isViable: true, strategyFunction: function () { } };
            ...
            var maxPercent = Math.min(nullSpacePercentage, ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT);
            var megaHeadProb = this._randomGenerator.integerInRange(Math.round(maxPercent / 2), maxPercent);
            var invaderProb = maxPercent - megaHeadProb;
            strategy.strategyFunction = function () {
                console.warn('_increaseMobEnemyConcentrationFromNullSpaceStrategy');
                return _this._reallocateProbFromNullSpace(type, [0, 0, 0, invaderProb, megaHeadProb]);
            };
            return strategy;
        };
        ExperientialGameManager.prototype._decreaseMobEnemyConcentrationAmountToNullSpaceStrategy = function () {
            var _this = this;
            var type = 'MOB';
            var halfDec = Math.round(ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT / 2);
            var strategy = { isViable: true, strategyFunction: function () { } };
        ...
        ExperientialGameManager.prototype._increaseAttackingMobEnemyConcentrationStrategy = function () {
            var _this = this;
            var type = 'MOB';
            var meteorPercentage = this._probabilityDistributions[type][2];
            var strategy = { isViable: true, strategyFunction: function () { } };
            if (meteorPercentage <= 0) {
                strategy.isViable = false;
                return strategy;
            }
            var maxPercent = Math.min(meteorPercentage, ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT);
            var megaHeadProb = this._randomGenerator.integerInRange(Math.round(maxPercent / 2), maxPercent);
            var invaderProb = maxPercent - megaHeadProb;
            strategy.strategyFunction = function () {
                console.warn('_increaseAttackingMobEnemyConcentrationStrategy');
                return _this._reallocateProbFromNullSpace(type, [0, 0, -maxPercent, invaderProb, megaHeadProb]);
            };
            return strategy;
        };
        ExperientialGameManager.prototype._decreaseAttackingMobEnemyConcentrationStrategy = function () {
            var _this = this;
            var type = 'MOB';
            var halfDec = Math.round(ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT / 2);
            var strategy = { isViable: true, strategyFunction: function () { } };
        ...
        ExperientialGameManager.prototype._increasePlatformConcentrationStrategy = function () {
            ...
            var maxPercent = Math.min(pushPlatformPercentage, ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT);
            strategy.strategyFunction = function () {
                console.warn('_increasePlatformConcentrationStrategy');
                return _this._reallocateProbFromNullSpace(type, [maxPercent, -maxPercent, 0]);
            };
            return strategy;
        };
        ExperientialGameManager.prototype._increasePushPlatformConcentrationStrategy = function () {
            var _this = this;
            var type = 'PLATFORM';
            var platformPercentage = this._probabilityDistributions[type][0];
            var strategy = { isViable: true, strategyFunction: function () { } };
            ...
            var maxPercent = Math.min(platformPercentage, ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT);
            strategy.strategyFunction = function () {
        ...
        ExperientialGameManager.INTERVAL_MS = 1000 * 15;
        ExperientialGameManager.MIN_SURVEY_TIME_INTERVAL_MS = 1000 * 30;
        ExperientialGameManager.IS_EXPERIENCE_MODEL_ENABLED = false;
        ExperientialGameManager.MAX_MOB_DIFFICULTY_LEVEL = 10;
        ExperientialGameManager.INCREASE_PLAYER_DIFFICULTY_MAX_NON_DEATH_DURATION = 60 * 1000;
        ExperientialGameManager.DIFFICULTY_DENSITY_PERCENT_INCREMENT = 5;
        ExperientialGameManager.PLAYER_AVERAGE_HEALTH_THRESHOLD = 70;
...
(function (PCGGame) {
    var GameMetric = (function () {
        ...
        GameMetric.prototype.tick = function (timeElapsedMS, playerHealth) {
        ...
        GameMetric.prototype.averagePlayerHealth = function () {
...
(function (PCGGame) {
    var PreferenceCondition = (function () {
        ...
        Object.defineProperty(PreferenceCondition.prototype, "preference", {
            get: function () {
    ...
    PCGGame.PreferenceCondition = PreferenceCondition;
})(PCGGame || (PCGGame = {}));
var PCGGame;
(function (PCGGame) {
    var SurveyManager = (function () {
        ...
        SurveyManager.prototype.setQuestion = function () {
            var questions = this.currentPreferenceCondition.questions;
            var questionsHTML = '';
